...
namespace RentalKendaraan_111.Models
{
    public partial class RentKendaraanContext : DbContext
    {
        ...
        public virtual DbSet<Kostumer> Kostumer { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kostumer>(entity =>
            {
                ...
                entity.HasOne(d => d.IdGenderNavigation)
                    .WithMany(p => p.Kostumer)
                    .HasForeignKey(d => d.IdGender)
                    .HasConstraintName("FK_Kostumer_Gender");
            });
            ...
            modelBuilder.Entity<Peminjaman>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCostumerNavigation)
                    ...
                    .HasConstraintName("FK_Peminjaman_Kostumer");
