...
namespace RentalKendaraan_111.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        {
            ViewData["IdCostumer"] = new SelectList(_context.Kostumer, "IdCostumer", "IdCostumer");
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TglPeminjaman,IdKendaraan,IdCostumer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
            ...
            ViewData["IdCostumer"] = new SelectList(_context.Kostumer, "IdCostumer", "IdCostumer", peminjaman.IdCostumer);
